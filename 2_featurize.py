...
2_featurize.py
==============
Stage 2: Molecular Featurization

Generates 4 molecular fingerprint representations for every compound:
  1. ECFP4 / Morgan (2048 bits)  — circular chemical environments
  2. MACCS keys (167 bits)        — fixed structural dictionary
  3. RDKit 2D descriptors (~200)  — named physicochemical properties
  4. Atom-pair (2048 bits)        — pairwise atom distances

All representations + labels saved to data/features.pkl.
"""
...
# ─────────────────────────────────────────────────────────────────────────
# Fingerprint 1: ECFP4 / Morgan (radius=2, 2048 bits)
# ─────────────────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
...
# ─────────────────────────────────────────────────────────────────────────
# Fingerprint 2: MACCS keys (167 bits)
# ─────────────────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
...
# ─────────────────────────────────────────────────────────────────────────
# Fingerprint 3: RDKit 2D physicochemical descriptors
# ─────────────────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
...
# Remove zero-variance descriptors (uninformative)
...
# Standardize (RDKit descriptors are continuous, unlike fingerprints)
...
# ─────────────────────────────────────────────────────────────────────────
# Fingerprint 4: Atom-pair (2048 bits)
# ─────────────────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
...
print()
print("✓ Stage 2 complete. Run 3_train_evaluate.py next.")
