...
6_figures.py
============
Stage 6: Additional Publication Figures

  Figure 1 : Pipeline overview schematic
  Figure 5 : Dataset EDA — IC50 distribution + chemical space (t-SNE)
  Figure 6 : pIC50 distribution + Lipinski property distributions
"""
...
# ── 5A: IC50 distribution (log scale) ────────────────────────────────────
...
# ── 5D: Molecular weight distribution ────────────────────────────────────
...
# Reduce first with PCA (speeds up t-SNE, standard practice)
...
print()
print("✓ Stage 6 complete. All pipeline stages done!")
print()
print("Next: paper/main.tex — LaTeX paper draft.")
