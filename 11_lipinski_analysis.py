"""
11_lipinski_analysis.py
========================
Lipinski Rule of Five (Ro5) drug-likeness analysis of active compounds.

Checks all 205 actives against:
  MW ≤ 500 Da
  LogP ≤ 5
  HBD ≤ 5
  HBA ≤ 10
...
def lipinski_pass(row):
    ...
    return violations <= 1   # Ro5 allows max 1 violation
...
# ── Figure: 4-panel descriptor distributions ──────────────────────────────
...
plt.close()
print("  ✓ figures/lipinski_analysis.png")
print()
